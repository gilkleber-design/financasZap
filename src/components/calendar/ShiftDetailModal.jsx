...
const kindColor = {
  ...
  sobreaviso: 'bg-orange-100 text-orange-700 border-orange-200',
};
const statusLabel = {
  scheduled: 'Agendado',
  done: 'Realizado',
...
export default function ShiftDetailModal({ shift, hospital, onClose, onPass, onDeleteFromHere }) {
  const [view, setView] = useState('detail'); // 'detail' | 'pass' | 'delete_confirm'
          ...
          <div className="space-y-4 py-1">
            ...
            <div>
              ...
              <Textarea
                ...
                rows={3}
                placeholder="Ex: combinamos trocar no dia X, valor X..."
                value={passedNotes}
      ...
      <Dialog open onOpenChange={onClose}>
        <DialogContent className="max-w-sm">
          ...
          <div className="flex gap-2">
            ...
            <Button
              variant="destructive"
              onClick={() => onDeleteFromHere(shift)}
              className="flex-1"
            >
              Sim, deletar
            </Button>
        ...
        <div className="space-y-3 py-1">
          ...
          <div className="bg-muted/30 rounded-xl p-4 space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Badge className={`text-xs border ${kindColor[shift.shift_kind]}`}>
                {shift.type} {kindLabel[shift.shift_kind]}
              </Badge>
            </div>
            <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm font-semibold text-emerald-600">{fmt(shift.valor)}</span>
            </div>
            {shift.notes && (
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-xl p-3 space-y-1">
              ...
              {shift.passed_date && (
                <p className="text-xs text-purple-600">
                  Data: {format(new Date(shift.passed_date + 'T12:00:00'), 'dd/MM/yyyy')}
                </p>
              )}
              {shift.passed_notes && (
