...
export default function CardInvoices() {
  ...
  const getCardItems = (cardId) => {
    return payables
      ...
      .sort((a, b) => {
        // Ordena pela data da compra (purchase_date prioritário, com fallbacks)
        const dateA = new Date(a.purchase_date || a.issue_date || a.due_date || 0);
        const dateB = new Date(b.purchase_date || b.issue_date || b.due_date || 0);
        return dateA - dateB;
      });
  };
